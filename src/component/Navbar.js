...
const Navbar = () => {
  return (
    <div className="py-4 border-b border-gray-500 flex justify-between items-center">
      ...
      <div className="flex gap-5">
        ...
        <img src={girl} alt="beautiful girl" className="object-cover bg-yellow-500  w-7 h-7 rounded-full" />
